...
%sinal = load('C:\Users\LVI\Desktop\Sávyo\Sávyo\projects\ordens do motor\input_sensor');
sinal = VarName1;
%plot(sinal);
...
MATRIX = [];%matriz responsavel por salvar os dados no dominio da frequencia
...
%AA=2000;
%BB=1950;
%spectrogram(sinal,AA,BB,AA,Fs,'yaxis');
